defmodule Website.CoffeeGridPage do
  use Tableau.Page,
    layout: Website.RootLayout,
    permalink: "/coffee/grid",
    title: "Coffee"
  ...
  def template(assigns) do
    ...
    <section class="space-y-8 not-prose">
      <div class="flex items-center gap-3 mb-2">
        ...
        <a href="/coffee/grid" class="text-[0.72rem] font-bold uppercase tracking-[0.09em] border-b-2 border-ink no-underline text-ink">Grid</a>
